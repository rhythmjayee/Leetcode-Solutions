...
<strong>Explanation:</strong> The two objects with id=1 are merged together. For the keys "b" and "v" the values from arr2 are used. Since the key "y" only exists in arr1, that value is taken form arr1.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
