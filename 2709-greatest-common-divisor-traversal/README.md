...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,3,6]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,9,5]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,3,12,8]
<strong>Output:</strong> true
