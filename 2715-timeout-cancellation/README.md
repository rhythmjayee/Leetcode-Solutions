...
<pre style="position: relative;"><strong>Input:</strong> fn = (x) =&gt; x * 5, args = [2], t = 20, cancelT = 50
...
<pre style="position: relative;"><strong>Input:</strong> fn = (x) =&gt; x**2, args = [2], t = 100, cancelT = 50 
...
<pre style="position: relative;"><strong>Input:</strong> fn = (x1, x2) =&gt; x1 * x2, args = [2,4], t = 30, cancelT = 100
